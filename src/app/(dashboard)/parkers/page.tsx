            ...
            <Card>
                <CardHeader>
                    <div className="flex flex-wrap gap-4 justify-between items-center">
                        <div>
                            <CardTitle>Parker Management</CardTitle>
                            ...
                            <TableBody>
                                {parkers.map(parker => (
                                    <TableRow key={parker.id}>
                                        ...
                                        <TableCell>
                                             <Badge variant="outline" className="capitalize">{parker.type}</Badge>
                                        </TableCell>
                                        <TableCell>{parker.plate}</TableCell>
                                        <TableCell>{parker.carModel}</TableCell>
                                        <TableCell>
                                            <Badge variant="secondary" className="capitalize">{parker.participation}</Badge>
                                        </TableCell>
